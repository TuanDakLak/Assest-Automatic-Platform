...
import { PptxDocument } from '../core/PptxDocument.js';
import { dedupeWarnings } from '../utils/WarningCollector.js';
/**
 ...
 */
export function shardRoundRobin(items, shards) {
...
export class RenderPool {
    ...
    async ensureWorkers(count) {
        ...
        while (this.workers.length < needed) {
            ...
            const entry = {
                worker: new Worker(url, { execArgv: [] }),
                pending: new Map(),
            };
    ...
    async findWorkerUrl() {
        if (this.workerUrlOption !== undefined) {
            ...
            return this.workerUrlOption.startsWith('file:')
                ...
                : pathToFileURL(this.workerUrlOption);
        }
        const candidates = [];
        let moduleDir;
        ...
        if (typeof __dirname !== 'undefined') {
            ...
            const { moduleUrl } = await import('./workerUrl.js');
 ...
 * ```
 */
export function createRenderPool(options = {}) {
    return new RenderPool(options);
}
//# sourceMappingURL=RenderPool.js.map