 ...
 */
export function findLibreOfficePath() {
 ...
 */
export async function generateBaselines(pptxPath, options = {}) {
 ...
 */
export async function generateBaselinesViaPdf(pptxPath, options = {}) {
    const startTime = Date.now();
    const opts = { ...DEFAULT_OPTIONS, ...options };
    // Validate PPTX file
    if (!fs.existsSync(pptxPath)) {
...
//# sourceMappingURL=BaselineGenerator.js.map