...
export class GroupShapeRenderer {
    ...
    getOrderedChildren(grpSpNode) {
        ...
        const orderedElements = getChildrenInDocumentOrder(grpSpNode, 'p:grpSp', SHAPE_ELEMENT_TYPES);
 ...
 */
export function createGroupShapeRenderer(scaleX, scaleY, logger) {
...
//# sourceMappingURL=GroupShapeRenderer.js.map