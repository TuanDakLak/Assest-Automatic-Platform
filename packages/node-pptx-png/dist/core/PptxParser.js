 ...
 */
export const trimTagValueExceptText = (tagName, tagText) => PRESERVE_WHITESPACE_TAGS.has(tagName) ? tagText : tagText.trim();
/**
 ...
 */
export const trimAttributeValue = (_attrName, attrValue) => attrValue.trim();
/**
 ...
 */
export function getXmlAttr(node, attr) {
    if (!node)
        return undefined;
 ...
 */
export function getXmlChild(node, path) {
    if (!node)
        return undefined;
    return node[path];
}
 ...
 */
export function hasXmlChild(node, path) {
    return node?.[path] !== undefined;
}
/**
 * Utility function to get a child element as array.
 */
export function getXmlChildren(node, path) {
    if (!node)
        return [];
 ...
 */
export function parseXmlPreservingOrder(xmlString) {
 ...
 */
export function getOrderedChildren(orderedNode, tagNames) {
    const result = [];
 ...
 */
export function extractOrderedElements(parentChildren, tagNames) {
 ...
 */
export function nodeToXmlString(node, wrapperTag) {
 ...
 * ```
 */
export function getChildrenInDocumentOrder(node, wrapperTag, childTagNames) {
...
//# sourceMappingURL=PptxParser.js.map