 ...
 */
export { EmfParser, isEmf, type EmfParserConfig } from './EmfParser.js';
export { WmfParser, isWmf, type WmfParserConfig } from './WmfParser.js';
export { EmfRenderer, type EmfRendererConfig } from './EmfRenderer.js';
export type { MetafileDib, MetafileHeader, MetafileLogFont, MetafilePoint, MetafileRecord, MetafileRect, MetafileXform, ParsedMetafile, } from './types.js';
