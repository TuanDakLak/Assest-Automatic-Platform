...
export class WmfParser {
    logger;
    constructor(config = {}) {
        this.logger = config.logger ?? createLogger('warn', 'WmfParser');
    }
    /**
     * Parses a WMF binary.
     *
    ...
    buildParsedMetafile(records, bbox, unitsPerInch, truncated) {
        ...
        const prelude = [
            { type: 'setMapMode', mode: MAP_MODE.ANISOTROPIC },
...
//# sourceMappingURL=WmfParser.js.map