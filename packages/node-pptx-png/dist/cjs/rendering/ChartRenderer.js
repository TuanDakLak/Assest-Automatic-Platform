...
exports.segmentSeriesValues = segmentSeriesValues;
 ...
 */
function segmentSeriesValues(values, limit) {
    const segments = [];
    let current = [];
...
class ChartRenderer {
    ...
    warnings;
    constructor(config = {}) {
        this.logger = config.logger ?? (0, Logger_js_1.createLogger)('warn', 'ChartRenderer');
 ...
 */
function createChartRenderer(logger) {
