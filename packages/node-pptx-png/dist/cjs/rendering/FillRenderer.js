...
exports.FillRenderer = void 0;
exports.computeLinearGradientPoints = computeLinearGradientPoints;
exports.createFillRenderer = createFillRenderer;
 ...
 */
function computeLinearGradientPoints(centerX, centerY, halfDiagonal, angleDegrees) {
...
class FillRenderer {
    ...
    colorResolver;
    constructor(config) {
        this.logger = config.logger ?? (0, Logger_js_1.createLogger)('warn', 'FillRenderer');
    ...
    renderFill(ctx, path, fill, bounds) {
        ...
        (0, PathBuilder_js_1.applyPathToContext)(ctx, path, true);
        switch (fill.type) {
            case 'solid':
    ...
    parseFill(spPr) {
        if (!spPr)
            return undefined;
        // Check for no fill
        if ((0, PptxParser_js_1.hasXmlChild)(spPr, 'a:noFill')) {
            return { type: 'none' };
        }
        ...
        const gradFill = (0, PptxParser_js_1.getXmlChild)(spPr, 'a:gradFill');
        if (gradFill) {
            return this.parseGradientFill(gradFill);
        }
        // Check for pattern fill
        const pattFill = (0, PptxParser_js_1.getXmlChild)(spPr, 'a:pattFill');
        if (pattFill) {
            return this.parsePatternFill(pattFill);
        }
        // Check for picture fill (blipFill)
        const blipFill = (0, PptxParser_js_1.getXmlChild)(spPr, 'a:blipFill');
        if (blipFill) {
    ...
    parseGradientFill(gradFill) {
        ...
        if (gsLst) {
            const gsNodes = (0, PptxParser_js_1.getXmlChildren)(gsLst, 'a:gs');
        ...
        if (path) {
            ...
            let centerY = 0.5;
            if (fillToRect) {
                const l = (0, PptxParser_js_1.getXmlAttr)(fillToRect, 'l');
                const t = (0, PptxParser_js_1.getXmlAttr)(fillToRect, 't');
                const r = (0, PptxParser_js_1.getXmlAttr)(fillToRect, 'r');
                const b = (0, PptxParser_js_1.getXmlAttr)(fillToRect, 'b');
                const left = l !== undefined ? (0, UnitConverter_js_1.percentageToDecimal)(parseInt(l, 10)) : 0;
                const top = t !== undefined ? (0, UnitConverter_js_1.percentageToDecimal)(parseInt(t, 10)) : 0;
                const right = r !== undefined ? (0, UnitConverter_js_1.percentageToDecimal)(parseInt(r, 10)) : 1;
                const bottom = b !== undefined ? (0, UnitConverter_js_1.percentageToDecimal)(parseInt(b, 10)) : 1;
    ...
    parsePatternFill(pattFill) {
        ...
        const fgClr = (0, PptxParser_js_1.getXmlChild)(pattFill, 'a:fgClr');
        const bgClr = (0, PptxParser_js_1.getXmlChild)(pattFill, 'a:bgClr');
        ...
        const preset = (0, PptxParser_js_1.getXmlAttr)(pattFill, 'prst') ?? 'solid';
        return {
            type: 'pattern',
            preset,
            foregroundColor,
    ...
    parsePictureFill(blipFill) {
        ...
        const embedId = blip ? ((0, PptxParser_js_1.getXmlAttr)(blip, 'r:embed') ?? '') : '';
 ...
 */
function createFillRenderer(theme, logger) {
