...
exports.AlternateContentRenderer = void 0;
exports.createAlternateContentRenderer = createAlternateContentRenderer;
 ...
 */
class AlternateContentRenderer {
    logger;
    constructor(config = {}) {
        this.logger = config.logger ?? (0, Logger_js_1.createLogger)('warn', 'AlternateContentRenderer');
    }
    /**
     ...
     */
    parseAlternateContent(alternateContentNode) {
        // Look for mc:Choice first
        const choice = (0, PptxParser_js_1.getXmlChild)(alternateContentNode, 'mc:Choice');
        if (choice) {
            const requires = (0, PptxParser_js_1.getXmlAttr)(choice, 'Requires');
        ...
        const fallback = (0, PptxParser_js_1.getXmlChild)(alternateContentNode, 'mc:Fallback');
        if (fallback) {
    ...
    extractChildren(node) {
        ...
        const elementTypes = constants_js_1.SHAPE_ELEMENT_TYPES.filter((t) => t !== 'mc:AlternateContent');
     ...
     */
    getChildTagName(node, fallbackNode) {
     ...
     */
    async renderAlternateContent(ctx, alternateContentNode, renderChild) {
     ...
     */
    static isAlternateContent(tagName) {
        return tagName === 'mc:AlternateContent';
    }
}
exports.AlternateContentRenderer = AlternateContentRenderer;
/**
 * Creates an AlternateContentRenderer instance.
 */
function createAlternateContentRenderer(logger) {
