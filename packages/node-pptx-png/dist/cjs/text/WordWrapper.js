...
exports.canMergeFragments = canMergeFragments;
exports.isCjkChar = isCjkChar;
exports.containsCjk = containsCjk;
exports.isKinsokuNoStartChar = isKinsokuNoStartChar;
exports.isKinsokuNoEndChar = isKinsokuNoEndChar;
exports.segmentWrapUnits = segmentWrapUnits;
exports.createWordWrapper = createWordWrapper;
 ...
 */
function canMergeFragments(existing, source) {
    if (!existing)
        return false;
 ...
 */
function isKinsokuNoStartChar(unit) {
 ...
 */
function isKinsokuNoEndChar(char) {
 ...
 */
function segmentWrapUnits(text) {
    const units = [];
    let nonCjk = '';
    const flushNonCjk = () => {
        if (!nonCjk)
...
class WordWrapper {
    ...
    constructor(config) {
        this.logger = config.logger ?? (0, Logger_js_1.createLogger)('warn', 'WordWrapper');
 ...
 */
function createWordWrapper(fontResolver, logger) {
