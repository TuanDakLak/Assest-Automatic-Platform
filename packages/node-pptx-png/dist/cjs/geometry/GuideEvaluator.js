...
exports.ANGLE_UNITS_PER_CIRCLE = exports.ANGLE_UNITS_PER_DEGREE = void 0;
exports.ooxmlAngleToRadians = ooxmlAngleToRadians;
exports.radiansToOoxmlAngle = radiansToOoxmlAngle;
exports.createGuideContext = createGuideContext;
exports.resolveGuideValue = resolveGuideValue;
exports.evaluateFormula = evaluateFormula;
exports.evaluateGuideList = evaluateGuideList;
/** OOXML angle units per degree (60000ths of a degree). */
exports.ANGLE_UNITS_PER_DEGREE = 60000;
/** OOXML angle units in a full circle (360° × 60000). */
exports.ANGLE_UNITS_PER_CIRCLE = 21600000;
/**
 * Converts an OOXML angle (60000ths of a degree) to radians.
 */
function ooxmlAngleToRadians(angle) {
    return (angle / exports.ANGLE_UNITS_PER_DEGREE) * (Math.PI / 180);
}
/**
 * Converts radians to an OOXML angle (60000ths of a degree).
 */
function radiansToOoxmlAngle(radians) {
    return (radians * 180 * exports.ANGLE_UNITS_PER_DEGREE) / Math.PI;
}
/**
 ...
 */
function createGuideContext(w, h, adjustments) {
 ...
 */
function resolveGuideValue(token, ctx) {
    ...
    if (angular?.[2] !== undefined) {
        ...
        if (divisor > 0) {
            return (multiplier * exports.ANGLE_UNITS_PER_CIRCLE) / divisor;
        }
    }
    // Numeric literal
 ...
 */
function evaluateFormula(fmla, ctx) {
 ...
 */
function evaluateGuideList(entries, ctx) {
